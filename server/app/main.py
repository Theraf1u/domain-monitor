...
from app.buffer_alert_monitor import BufferAlertMonitor
...
async def lifespan(app: FastAPI):
    ...
    buffer_alert_monitor = BufferAlertMonitor(db, notifier)
    background_tasks = [
        ...
        asyncio.create_task(buffer_alert_monitor.run()),
    ]
